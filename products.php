        ...
        <div class="list-content text-center" >
            <ul class="list-group">
                ...
                <li class="col-sm-12 col-md-10 list-group-item text-left" style="color:black;list-style-type: none;margin-bottom: 10px">
                    ...
                    <span style="margin-right: 10px"><?php echo "Producent ".$product["brand"]?></span>
                    <span style="margin-right: 10px"><?php echo "Kategoria ".$product["category"]?></span>
                    <span style="margin-right: 10px"><?php echo $product["price"]. " PLN"?></span>
                    <span >
                        <button type="button" class="editBtn btn btn-success btn-xs"  >EDIT</button>
                        <button  class="editBtn btn btn-danger  btn-xs"  >DELETE</button>
                    </span>
                </li>
                    <?php
                }
